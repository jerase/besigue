// ============================================================
// MOTEUR COMBINAISONS
// : Détection, validation, réutilisation des 14 combis
// ============================================================
...
function detecterMariages(
 ...
 // Règle : une paire (roi,dame) identique ne peut former qu'un seul mariage
 const dejaAnnonce =
...
// ============================================================
// CARRÉS _ATOUT (sans Joker, même couleur que l'atout)
// ============================================================
...
// ============================================================
// CARRÉS NORMAUX (Joker autorisé, couleurs quelconques)
...
export function appliquerAnnonce(
 ...
 if (roi) {
 newState = { ...newState, couleurAtout: roi.couleur }
...
// ============================================================
// GÉRER LA CASSURE DU MARIAGE_ATOUT
...
// ============================================================
// INITIALISER les champs dans le GameState
// ============================================================
