// ============================================================
// MOTEUR DE FIN DE MANCHE
// Brisques, bonus dernier pli, victoire
// ============================================================
...
// ============================================================
// Compter les brisques (As + 10) dans une pile
// ============================================================
...
// ============================================================
// Appliquer fin de manche complète
// ============================================================
...
export function appliquerFinManche(
 ...
 brisques = {
 brisquesJ0: compterBrisques(newState.joueurs[0].pileRemportee),
 brisquesJ1: compterBrisques(newState.joueurs[1].pileRemportee),
 deltaJ0: 0,
 deltaJ1: 0,
...
// ============================================================
// Détecter si la phase finale doit se déclencher
// ============================================================
