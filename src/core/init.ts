...
export const NB_CARTES_INITIALES = 9

/**
 * Nombre de cartes dans la pioche au début d'une manche.
 * Calculé : taille du deck − cartes distribuées aux 2 joueurs.
 * Utilisé par la jauge de pioche et tout affichage de progression.
 * 132 cartes (4 jeux × 32 + 4 jokers) − 18 (2 × 9) = 114
 */
export const NB_CARTES_PIOCHE_INITIALE = 132 - NB_CARTES_INITIALES * 2
...
// ============================================================
// INITIALISER UNE PARTIE COMPLÈTE
// ============================================================
