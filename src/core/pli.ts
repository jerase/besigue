// ============================================================
// MOTEUR DE PLI — IT-3
// SF-09 : Règles du pli (phase libre et finale)
// ============================================================
...
// ============================================================
// SF-09.1 — Déterminer le vainqueur d'un pli
// ============================================================
...
// ============================================================
// SF-09.2 — Cartes jouables en phase finale
...
// ============================================================
// SF-08 — Appliquer un pli complet sur le GameState
// ============================================================
...
export function appliquerPli(state: GameState): GameState {
  ...
  // Bonus 7 d'atout (SF-08.1 Étape 3 + SF-10.10)
  let newState = { ...state }
  if (couleurAtout) {
